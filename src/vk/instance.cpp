                   ...
                   std::optional<Debugger>& debugger)
{
   ...
   for (const auto& device : devices) {
      _physical_devices.emplace_back(std::make_shared<NewPhysicalDevice>(this, device));
   }
...
const std::vector<std::shared_ptr<NewPhysicalDevice>>& Instance::get_physical_devices() const
{
